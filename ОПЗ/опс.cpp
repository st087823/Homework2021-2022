...
/*Считываем выражение, записанное в обратной польской записи.
а) если встретилось число, то оно записывается в стек.
б) если встретился знак операции, то из стека берутся два верхних числа; над
ними производится операция.Результат помещается обратно в стек.

В конечном итоге в стеке должно находиться одно число, которое и будет ре -
зультатом выражения.*/
